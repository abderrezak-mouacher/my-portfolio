      ...
      >
        ...
        >
          ...
          <g
            ...
            opacity="0.55"
          >
           <path className="trace-path" d="M -20 120 H 260 L 320 180 " style={{ animationDelay: '0.1s' }} />
            <path className="trace-path" d="M -20 500 H 180 L 240 440 H 520 L 580 400" style={{ animationDelay: '0.3s' }} />
          ...
          <g fill="#4fdb82">
            <circle className="via-node" style={{ animationDelay: '1.6s' }} cx="320" cy="180" r="4" />
            <circle className="via-node" style={{ animationDelay: '1.8s' }} cx="550" cy="420" r="4" />
